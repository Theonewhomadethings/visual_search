...
for k = 2:SHOW % Start from the second result to avoid using the query image    
    ...
    precision_array(k - 1) = precision_at_k;  % Adjust the index
    recall_array(k - 1) = recall_at_k;  % Adjust the index
