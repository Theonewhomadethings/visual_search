...
%% and call a function 'extractRGB_histogram' to extract a descriptor from the
%% image.
...
for filenum=1:length(allfiles)
    ...
    % Extract descriptor from the image using the 'extractRGB_histogram' function
    F=extractRGB_histogram(img);
