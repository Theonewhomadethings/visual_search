...
%DESCRIPTOR_SUBFOLDER = 'globalRGBhisto'; % For globalRGBhistogram descriptros
%DESCRIPTOR_SUBFOLDER = 'spatialGridColour1'; %for spatial colour grid for just average color feature 
%DESCRIPTOR_SUBFOLDER = 'spatialGridColour2'; %for spatial colour grid for just colour histogram
%DESCRIPTOR_SUBFOLDER = 'spatialGridColour3'; %for spatial colour grid for colour moments
%DESCRIPTOR_SUBFOLDER = 'spatialGridColour4'; %all colour features concatenated

DESCRIPTOR_SUBFOLDER = 'spatialGridTexture1'; %texture feature 1: EOH + Sobel Filter
